...
require HTTPS discovery, with HTTP allowed only for localhost and loopback development.
They support indexed reads only. See [the distribution contract](../docs/browser-delivery.md).
